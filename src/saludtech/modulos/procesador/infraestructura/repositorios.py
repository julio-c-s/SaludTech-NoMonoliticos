from saludtech.modulos.procesador.dominio.repositorio import RepositorioImagenes
from saludtech.modulos.procesador.infraestructura.excepciones import RepositorioException
from saludtech.modulos.procesador.infraestructura.mapeadores import mapear_a_entidad, mapear_a_registro

# Import the ORM model. Ensure that this model is defined to match your ImagenMedica entity.
from saludtech.modulos.procesador.infraestructura.modelos import ImagenMedicaModel
