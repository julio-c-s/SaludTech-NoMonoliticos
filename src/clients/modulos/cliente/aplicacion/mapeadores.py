...
from clients.modulos.vuelos.dominio.objetos_valor import Itinerario, Odo, Segmento, Leg
# from clients.modulos.vuelos.dominio import ReservaDTO, ItinerarioDTO, OdoDTO, SegmentoDTO, LegDTO
