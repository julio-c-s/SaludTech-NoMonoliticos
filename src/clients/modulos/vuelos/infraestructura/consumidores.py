...
from clients.modulos.vuelos.infraestructura.schema.v1.eventos import EventoReservaCreada
from clients.modulos.vuelos.infraestructura.schema.v1.comandos import ComandoCrearReserva
