from clients.seedwork.aplicacion.queries import Query, QueryHandler, QueryResultado
from clients.seedwork.aplicacion.queries import ejecutar_query as query
